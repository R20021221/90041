...
public final class Constants {
    ...
    public static final int NUM_OF_CMD_ARGS = 5;
    ...
    public static final String MENU_VIEW_SUMMARY = "3";
    public static final String MENU_VIEW_PAYSLIP = "4";
    public static final String MENU_SUPERVISOR_REPORTEES = "5";
    public static final String MENU_SUPERVISOR_LOGOUT = "6";
    ...
    public static final String MENU_RETURN = "X";
